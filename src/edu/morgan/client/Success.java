...
import edu.morgan.server.MyMain;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
        	...
        	if(request.getParameter("code") != null){
	            ...
	            ArrayList<IncompleteStudent> incompletestudents = (ArrayList<IncompleteStudent>)request.getAttribute("incompleteStudents");
	            
	            MyMain main = new MyMain();
	            GoogleDrive gd = new GoogleDrive(code);
	            //main.Start(new GoogleDrive(request.getParameter("code")), out, incompletestudents);
